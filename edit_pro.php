...
if(!isset($_SESSION['admin']))
  ...
  else  
  {
	...
	$d="update product set cat_id=".$_POST['i1'].",subcat_id=".$_POST['i2'].",p_nm='".$_POST['i3']."',img='$filename',price=".$_POST['i4'].",description='".$_POST['i5']."' where p_id=".$_GET['sid'];
       
	$rs1=mysqli_query($con,$d);
  ...
  <div class="container-fluid">
	...
	<div id="main">
		...
		<?php
			...
			$a=$_GET['sid'];
			$q="select * from product where p_id=".$a;
			$rs=mysqli_query($con,$q)or die("error");
      ...
      subcat_id : <select name="i2" id="s2">
				<option value="">---select---</option>
				<script>
			...
			Product Name : <input type=text value=<?= $h['p_nm'] ?> name="i3" required><br><br>
			Price : <input type=text value=<?= $h['price'] ?> name="i4" required><br><br>
			Description : <input type=text value=<?= $h['description'] ?> name="i5" required><br><br>
			
			Image : <input type=file  name="f1" required>
		  <img src="./image/<?php echo $h['img']; ?>" height="0px" width="0px"><br><br>

					<input type=hidden value=<?php $h['p_id'] ?> name="vj1">
					

					<input type="submit" class="btn-1" name="b1" value="Update">
