...
if(!isset($_SESSION['admin']))
  ...
  $conn=mysqli_connect('localhost','root','','shoping');
		...
		if(isset($_POST['b1']))
		{
			$j="delete from user where id=".$_GET['uid'];
			
			$rs=mysqli_query($conn,$j) or die("quey not fire");
...
<link rel="stylesheet" href="ocss/user.css">
...
<nav class="navbar bg-body-tertiary fixed-top">
  <div class="container-fluid">
	...
	<div id="main">
		...
		<hr><h2>Delete Users</h2><hr><br><br>
		
		<?php
		
			$a=$_GET['uid'];
			$q="select * from user where id=".$a;
			$rs=mysqli_query($conn,$q)or die("error");
			...
			if(mysqli_num_rows($rs)>0)
			{
				foreach($rs as $h)
				{
					...
					<label>Full Name : </label>&nbsp;&nbsp;&nbsp; <input type=text class=inp-1 value=<?= $h['name'] ?> name="i1" required><br><br>
          <label>Phone : </label>&nbsp;&nbsp;&nbsp; <input type=text class=inp-2 value=<?= $h['phone'] ?> name="i1" required><br><br>
          <label>Email : </label>&nbsp;&nbsp;&nbsp; <input type=text class=inp-3 value=<?= $h['email'] ?> name="i1" required>
						<input type=hidden value=<?php $h['id'] ?> name="vj1"><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" class="btn-1" name="b1" value="Delete">
