...
if(!isset($_SESSION['admin']))
  ...
  else  
  {
    ...
    exit();
		...
		if(isset($_POST['b1']))
		{
			$d="delete from sub_cat where subcat_id=".$_GET['sid'];
			
			$rs=mysqli_query($conn,$d) or die("quey not fire");
...
<nav class="navbar bg-body-tertiary fixed-top">
  <div class="container-fluid">
	...
	<div id="main">
		...
		<h2>Delete Sub-Categories</h2><br><br>
		...
		<?php
			...
			if(mysqli_num_rows($rs)>0)
			{
				foreach($rs as $h)
				{
					...
					sub-category :&nbsp;&nbsp;&nbsp; <input type=text value=<?= $h['subcat_nm'] ?> name="t1" required>
						<input type=hidden value=<?php $h['subcat_id'] ?> name="vj1"><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
