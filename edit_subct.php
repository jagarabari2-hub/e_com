...
if(!isset($_SESSION['admin']))
  ...
  else  
  {
	...
	$d="update sub_cat set subcat_nm='".$_POST['t2']."',img='$filename' where subcat_id=".$_GET['sid'];
	
	$rs1=mysqli_query($conn,$d);
...
<nav class="navbar bg-body-tertiary fixed-top">
  <div class="container-fluid">
	...
	<div id="main">
		...
		<h2>Edit Sub-Categories</h2><br><br>
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" >
		
		<?php
		
			$a=$_GET['sid'];
			$q="select * from sub_cat where subcat_id=".$a;
			...
			sub-category :<input type=text value=<?= $h['subcat_nm'] ?> name="t2" required><br><br>
			
			Image : <input type=file  name="f1" required>
			<img src="./image/<?php echo $h['img']; ?>" height="0px" width="0px"><br><br>

					<input type=hidden value=<?php $h['subcat_id'] ?> name="vj1">
					<input type=hidden value=<?php $h['cat_id'] ?> name="vj1">
