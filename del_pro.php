...
if(!isset($_SESSION['admin']))
  ...
  else  
  {
    ...
    if(isset($_POST['b1']))
    {
	    ...
	    $d="delete from product where p_id=".$_GET['sid'];
    
	    $rs1=mysqli_query($con,$d) or die('Query not fire'); 
...
<div id="main">
	<div class="container-1">
		...
		<?php
			...
			Product Name : <input type=text value=<?= $h['p_nm'] ?> name="i3" required>
			

					<input type=hidden value=<?php $h['p_id'] ?> name="vj1"><br><br>
