<?php
  ...
  if(isset($_POST['b1']))
		...
		{
			$j="update user set name='".$_POST['i1']."',phone=".$_POST['i2'].",email='".$_POST['i3']."' where id=".$_GET['uid'];
...
<nav class="navbar bg-body-tertiary fixed-top">
  <div class="container-fluid">
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div id="main">
        <hr><h2>Edit Users</h2><hr><br><br>
		<?php
		
			$a=$_GET['uid'];
			$q="select * from user where id=".$a;
			...
			if(mysqli_num_rows($rs)>0)
			{
				foreach($rs as $h)
				{
					...
					<input type=text class=inp-1 value=<?= $h['name'] ?> name="i1" required><br><br>
          <label>Phone</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type=text class=inp-2 value=<?= $h['phone'] ?> name="i2" required><br><br>
          <label>Email</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type=email class=inp-3 value=<?= $h['email'] ?> name="i3" required>
                    &nbsp;
					<input type=hidden value=<?php $h['id'] ?> name="vj1"><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
