...
session_start();
  ...
  {
    header('location:new-pas.php');
    $con=mysqli_connect('localhost','root','','shoping')or die('db not connect');
    $u="INSERT INTO user_1(email)VALUES('".$_POST['i1']."')";
  ...
  <div class="container-fluid">
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <label>Email</label><input class="inp-01" value="" type="email" name="i1" placeholder="Enter your Email here" required><br>

     
 <br>
        <input type="submit" name="submit" value="SUBMIT" class="btn-01">
        <input type="reset" name="b1" value="CANCEL" class="btn-02">
    </form>
