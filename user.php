<?php
  $con=mysqli_connect('localhost','root','','shoping')or die('db not connected');
  session_start();
  ...
  if(isset($_POST['b1']))
		{
			$j="INSERT INTO user(name,phone,email) VALUES('".$_POST['i1']."',".$_POST['i2'].",'".$_POST['i3']."')"or die('db not connect');
			
			$rs=mysqli_query($con,$j) or die("quey not fire");
		}
...
<link rel="stylesheet" type="text/css" href="ocss/user.css">
</head>
<body>
<nav class="navbar bg-body-tertiary fixed-top">
  <div class="container-fluid">
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
    ...
    <div id="main">
		<hr><h1 class="txt-1">Users</h1><hr><br><br>
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            <label>Full Name :</label>&nbsp;&nbsp;&nbsp;&nbsp;<input class="inp-1" type="text" name="i1" required><br><br>
            <label>Phone : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="inp-2" type="text" name="i2" required><br><br>
            <label>Email : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="inp-3" type="email" name="i3" required><br><br>  
    
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn-1" type="submit" name="b1" value="Add">
        </form><br><br>

        <hr>
		<h2 class="txt-3">View Users</h2>
		<hr>
		<br><br>
		...
		$q="select * from user LIMIT $start_from, $limit";
		...
		if(mysqli_num_rows($rs)>0)
		{
			foreach($rs as $h)
			{
				...
				<div class="row">
				<div class="col"><?= $h['id'] ?></div>
				<div class="col"><?= $h['name'] ?></div>
        		<div class="col"><?= $h['phone'] ?></div>
        		<div class="col"><?= $h['email'] ?></div>
				<div class="col"><a class=sour href="edit_user.php?uid=<?= $h['id']; ?>">Edit</a></div>
				<div class="col"><a class=sour href="del_user.php?uid=<?= $h['id']; ?>">Delete</a></div>
				</div><hr>
				<?php
			}
		}
		...
		<?php
				...
				for ($i=1; $i<=$total_pages; $i++) {
					if ($i==$pn)
					{
						$pagLink .= "<li class='Pg-1'><a class=j1 href='user.php?page="
														  .$i."'>".$i."</a></li>";
					}
					else
					{
						$pagLink .= "<li class='Pg-1'><a class=j1 href='user.php?page=".$i."'>
														  ".$i."</a></li>";
					}
				};
				echo $pagLink;
